...
def calcFk(robot, ec):
    ...
    start_angle = [0, 0.557737, -1.5184888, 0, -1.3036738, 0, 0]  # 单位弧度
...
def set_soft_limit(robot, ec):
    ...
    soft_limits = [[-3.1066860685499065, 3.1066860685499065], 
                   [-2.0943951023931953, 2.0943951023931953], 
                   [-3.1066860685499065, 3.1066860685499065], 
                   [-1.0471975511965976, 2.530727415391778], 
                   [-3.1066860685499065, 3.1066860685499065], 
                   [-0.9599310885968813, 0.9599310885968813], 
                   [-0.9599310885968813, 0.9599310885968813]]
